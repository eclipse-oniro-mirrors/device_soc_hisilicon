...
typedef struct {
    ...
    hi_void *dma_virt;         /* cpu virtual addr mapped from dam addr */
 ...
 */
#define hi_handle_init(mod, private_data, chnid)  \
...
/* allow modules to define internal error code, from 0x1000. */
...
#define HI_LOG_ERR_UNKNOWNED        log_errcode_def(0x0021)      /* Unknown Error */
...
#else
#define hi_print_hex(name, str, len) print_string(name, str, len)
#endif
