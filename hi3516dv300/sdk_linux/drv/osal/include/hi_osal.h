...
extern void osal_iounmap(void *addr, unsigned long size);
...
/* mmz apis */
extern unsigned long long  cmpi_mmz_malloc(const char *mmz_name, const char *buf_name, unsigned long ul_size);
extern void cmpi_mmz_free(unsigned long long phy_addr, void *vir_addr);
extern int cmpi_mmz_malloc_nocache(const char *cp_mmz_name, const char *buf_name,
                                   unsigned long long *phy_addr, void **pp_vir_addr, unsigned long ul_len);
extern int  cmpi_mmz_malloc_cached(const char *cp_mmz_name, const char *buf_name,
                                   unsigned long long *phy_addr, void **pp_vir_addr, unsigned long ul_len);
extern int cmpi_check_mmz_phy_addr(unsigned long long phy_addr, unsigned int len);

void *cmpi_remap_cached(unsigned long long phy_addr, unsigned long ul_size);
void *cmpi_remap_nocache(unsigned long long phy_addr, unsigned long ul_size);
void cmpi_unmap(void *virt_addr);

#ifdef CONFIG_USER_SPACE
extern int cmpi_get_fd(void);
extern void cmpi_set_fd(int fd);
#endif
