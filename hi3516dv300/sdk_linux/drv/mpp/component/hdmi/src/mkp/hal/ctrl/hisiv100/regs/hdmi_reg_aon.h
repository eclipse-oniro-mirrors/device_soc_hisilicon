...
int hdmi_reg_aon_regs_init(char *addr);
...
int hdmi_reg_hpd_polarity_ctl_get(void);
int hdmi_reg_hotplug_state_get(void);
int hdmi_reg_phy_rx_sense_get(void);
int hdmi_reg_aon_intr_stat0_get(void);
int hdmi_reg_aon_intr_stat1_get(void);
int hdmi_reg_ddc_scl_st_get(void);
int hdmi_reg_ddc_sda_st_get(void);
