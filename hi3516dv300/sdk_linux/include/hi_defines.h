...
/* For VB */
#define VB_MAX_KERNEL_POOLS            512
#define VB_MAX_USER_POOLS              512
#define VB_MAX_POOLS                   (VB_MAX_USER_POOLS + VB_MAX_KERNEL_POOLS)
