...
typedef struct hiHIGV_MSGINFO_S {
    ...
    HI_U32 LowLevelMsgNum; /* Low level message number , */
    HI_U32 CanLoseMsgNum; /* The message number which can lose, */
    HI_U32 LoseMsgNum; /* The message number which  losed, */
...
typedef enum hiHIGV_KEYCODE_E {
    ...
    /* the punctuation key on keyboard */
    ...
    /* the shift key of punctuation key on keyboard */
...
/*
* brief Send synchroniztion message.
...
* retval ::HI_ERR_COMM_PAERM Unsupported operation, such as, send key message.
* see ::
* HI_GV_Msg_SendAsync
* HI_GV_Msg_PostAsync
...
/*
* brief Send the asynchronism.
* param[in] widgetHandle Wiget handle.
* param[in] msgId  Message ID. The msg id is defined in "hi_gv_widget.h"
* .
...
/*
* brief Send the asynchronism which can loss.
* param[in] widgetHandle Widget handle.
* param[in] msgId  Message ID. The msg id is defined in "hi_gv_widget.h"
* .
* decided by message type.
...
/*
* brief Send the data attached the message which is not allowed to loss.
* param[in] widgetHandle Widget handle.
* param[in] msgId  Message ID. The msg id is defined in "hi_gv_widget.h"
* .
* data.
