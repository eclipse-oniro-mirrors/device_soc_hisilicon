...
/*
* brief: Initiatlize the higvCharts. [CN]:Chart ؼʼ
* param[in] handle:Chart control handle. [CN]:Chartؼľ
* param[in] style: Chart control's main property structure.[CN]:ChartؼԽṹ
* param[in] barAttr: Chart control's subsidiary child item cluster properties.[CN]:ChartؼĸĿԽṹ
* param[in] barCnt: Number of sub-items of Chart control.[CN]:ChartؼĸĿ
* retval ::HI_SUCCESS
...
* attition[CN]: ڻǰô˽ӿڽ
* param[in] handle:Chart control handle. [CN]:Chartؼľ
* param[in] pos: The number of the polyline to belong to, starting from 0.[CN]:ţ0ʼ
* param[in] color: The color of this polyline.[CN]:ߵɫ
...
/*
* brief: Set polyline title for display on legend, [CN]:߱⣬ͼʾ
* param[in] handle:Chart control handle. [CN]:Chartؼľ
...
* param[in] handle:Chart control handle. [CN]:Chartؼľ
* param[in] name:Polyline title. [CN]:߱
* param[in] barChartValue:Histogram bound points, [CN]:״ͼ󶨵ĵ
...
* brief[CN]:״ͼĿģʽ£x᷽ϸ״ͼǩ
* param[in] handle:Chart control handle. [CN]:Chartؼľ
* param[in] name:Polyline title. [CN]:
* param[in] length:Incoming name length, [CN]:Ƴ
* param[in] pos: The number of the Histogram to belong to, starting from 0.[CN]:״ͼţ0ʼ
* retval ::HI_SUCCESS
* retval ::HI_ERR_COMM_LOST
* retval ::HI_ERR_COMM_INVAL
*/
...
* brief[CN]:ͼģʽ£滻Xǩ滻Ϊʱ
* param[in] handle:Chart control handle. [CN]:Chartؼľ
* param[in] name:Replace x-axis tick label names. [CN]:滻x̶ȱǩ
* param[in] length:Incoming name length, [CN]:Ƴ
* param[in] pos: The number of the x-axis tick labels belong to, starting from 0.[CN]:x ǩλţ0ʼ
* retval ::HI_SUCCESS
* retval ::HI_ERR_COMM_LOST
* retval ::HI_ERR_COMM_INVAL
* retval ::HI_ERR_COMM_NORES
