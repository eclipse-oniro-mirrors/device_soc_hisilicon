 ...
 * param[in] animHandle  The animation instance handle
 * param[out] currentTime  Animation running time
 * retval ::HI_SUCCESS
 * retval ::HI_ERR_COMM_INVAL
 * retval ::HI_ERR_COMM_LOST
...
/*
 * brief  Register the animation execution listener
 * param[in] animHandle The animation instance handle
 * param[in] func  Listener function
 * retval ::HI_SUCCESS
 * retval ::HI_FAILURE
 ...
 * param[in] animInfoHandle The handle of animation information
...
/*
 * brief  Destroy animation instance
 * attention:Destroy animation instance
 * param[in] windowHandle  The handle of window instance
 * param[in] animHandle The handle of animation information
 * retval :: HI_SUCCESS is OK, other is error
 * retval ::HI_FAILURE
