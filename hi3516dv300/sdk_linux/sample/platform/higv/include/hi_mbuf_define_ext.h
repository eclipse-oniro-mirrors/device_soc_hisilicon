 ...
 */
#ifndef HI_MBUF_DEFINE_EXT_H
#define HI_MBUF_DEFINE_EXT_H
...
typedef HI_S32 (*Mbuf_Alloc_Func)(const HI_VOID *argv, HI_U32 u32BufSize, HI_VOID **ppVmAddr);

typedef HI_S32 (*Mbuf_Free_Func)(const HI_VOID *argv, HI_VOID *pVmAddr);

typedef HI_S32 (*Mbuf_Mcopy_Func)(const HI_VOID *argv, HI_VOID *pDest, const HI_VOID *pSrc, HI_U32 u32Size);

typedef HI_S32 (*Mbuf_CreateLock_Func)(const HI_VOID *argv);

typedef HI_S32 (*Mbuf_DestroyLock_Func)(const HI_VOID *argv);

typedef HI_S32 (*Mbuf_Lock_Func)(const HI_VOID *argv);

typedef HI_S32 (*Mbuf_UnLock_Func)(const HI_VOID *argv);
