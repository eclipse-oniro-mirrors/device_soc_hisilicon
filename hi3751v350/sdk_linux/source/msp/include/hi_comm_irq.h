...
/* For IRQ */
#define HI_MAX_STATE_NUM       2

#define VI_MAX_DEV_NUM 1
#define VI_MAX_PHY_PIPE_NUM 1
#define VI_MAX_ISP_FE_NUM 1

#define AIO_TX_MAX_NUM 8
#define AIO_RX_MAX_NUM 8
#define AIO_SPDIFTX_MAX_NUM 4
...
typedef struct {
    ...
    unsigned int tx_raw_state[AIO_TX_MAX_NUM];
    unsigned int tx_stat_state[AIO_TX_MAX_NUM];
    unsigned int rx_raw_state[AIO_RX_MAX_NUM];
    unsigned int rx_stat_state[AIO_RX_MAX_NUM];
    unsigned int spdiftx_raw_state[AIO_SPDIFTX_MAX_NUM];
    unsigned int spdiftx_stat_state[AIO_SPDIFTX_MAX_NUM];
} hi_aio_int_state;
...
typedef struct {
    ...
    unsigned int tx_clr_reg[AIO_TX_MAX_NUM];
    unsigned int tx_raw_reg[AIO_TX_MAX_NUM];
    unsigned int tx_stat_reg[AIO_TX_MAX_NUM];
    unsigned int rx_clr_reg[AIO_RX_MAX_NUM];
    unsigned int rx_raw_reg[AIO_RX_MAX_NUM];
    unsigned int rx_stat_reg[AIO_RX_MAX_NUM];
    unsigned int spdiftx_clr_reg[AIO_SPDIFTX_MAX_NUM];
    unsigned int spdiftx_raw_reg[AIO_SPDIFTX_MAX_NUM];
    unsigned int spdiftx_stat_reg[AIO_SPDIFTX_MAX_NUM];
} hi_aio_int_reg;
