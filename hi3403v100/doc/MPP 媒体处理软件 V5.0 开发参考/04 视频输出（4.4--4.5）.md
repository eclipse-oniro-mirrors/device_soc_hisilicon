# 视频输出（4.4--4.5）<a name="ZH-CN_TOPIC_0000002539080337"></a>

-   **[错误码](#ZH-CN_TOPIC_0000002503965647)**  
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11708mcpsimp"><a name="p11708mcpsimp"></a><a name="p11708mcpsimp"></a>最多(OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>) 35个设备</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11714mcpsimp"><a name="p11714mcpsimp"></a><a name="p11714mcpsimp"></a>最多(OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>) 35个设备</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11720mcpsimp"><a name="p11720mcpsimp"></a><a name="p11720mcpsimp"></a>最多(OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>) 34个设备</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.3.1.2 "><p id="p11726mcpsimp"><a name="p11726mcpsimp"></a><a name="p11726mcpsimp"></a>最多(OT_VO_MAX_PHYS_DEV_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>) 35个设备</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p12098mcpsimp"><a name="p12098mcpsimp"></a><a name="p12098mcpsimp"></a>最多(OT_VO_MAX_PHYS_LAYER_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>)共42个视频层和图形层。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p12104mcpsimp"><a name="p12104mcpsimp"></a><a name="p12104mcpsimp"></a>最多(OT_VO_MAX_PHYS_LAYER_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>)共40个视频层和图形层。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p12110mcpsimp"><a name="p12110mcpsimp"></a><a name="p12110mcpsimp"></a>最多(OT_VO_MAX_PHYS_LAYER_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>)共40个视频层和图形层。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p12116mcpsimp"><a name="p12116mcpsimp"></a><a name="p12116mcpsimp"></a>最多(OT_VO_MAX_PHYS_LAYER_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>)共38个视频层和图形层。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p12122mcpsimp"><a name="p12122mcpsimp"></a><a name="p12122mcpsimp"></a>最多(OT_VO_MAX_PHYS_LAYER_NUM + OT_VO_MAX_VIRT_DEV_NUM + <a href="#ZH-CN_TOPIC_0000002503965613">OT_VO_MAX_CAS_DEV_NUM</a>)共41个视频层和图形层。</p>
</td>
</tr>
</tbody>
</table>
...
[ot\_vo\_pub\_attr](#ZH-CN_TOPIC_0000002470925730)
...
[ot\_vo\_video\_layer\_attr](#ZH-CN_TOPIC_0000002503965649)
...
[ot\_vo\_chn\_attr](#ZH-CN_TOPIC_0000002471085702)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p14002mcpsimp"><a name="p14002mcpsimp"></a><a name="p14002mcpsimp"></a>固定频点类型时钟源，参考范围见<a href="#ZH-CN_TOPIC_0000002470925722"><span xml:lang="fr-FR" id="ph14004mcpsimp"><a name="ph14004mcpsimp"></a><a name="ph14004mcpsimp"></a>ot_vo_fixed_clk</span></a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ot\_vo\_user\_sync\_info](#ZH-CN_TOPIC_0000002503965651)
...
<td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.7.1.4 mcps1.2.7.1.5 mcps1.2.7.1.6 "><p id="p14733mcpsimp"><a name="p14733mcpsimp"></a><a name="p14733mcpsimp"></a>NA</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.2.3.1.2 "><p id="p14770mcpsimp"><a name="p14770mcpsimp"></a><a name="p14770mcpsimp"></a><a href="#ZH-CN_TOPIC_0000002470925660">ot_vo_intf_sync</a> intf_sync = {</p>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.2.3.1.2 "><p id="p14795mcpsimp"><a name="p14795mcpsimp"></a><a name="p14795mcpsimp"></a>pixel_clk=148.5MHz。从<a href="#table13230mcpsimp">表1</a>可知。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.2.3.1.2 "><p id="p14814mcpsimp"><a name="p14814mcpsimp"></a><a name="p14814mcpsimp"></a>从<a href="#_Ref18008712">表2</a>可知：src_clk= pre_div*pixel_clk*<span xml:lang="fr-FR" id="ph14816mcpsimp"><a name="ph14816mcpsimp"></a><a name="ph14816mcpsimp"></a> dev_div</span> =594MHz</p>
</td>
</tr>
...
<p id="p14846mcpsimp"><a name="p14846mcpsimp"></a><a name="p14846mcpsimp"></a>从<a href="#_Ref27641630">表1</a>可知：</p>
...
<p id="p14856mcpsimp"><a name="p14856mcpsimp"></a><a name="p14856mcpsimp"></a>从<a href="#_Ref27676820">表1</a>可知。</p>
</td>
</tr>
...
[ot\_vo\_user\_sync\_attr](#ZH-CN_TOPIC_0000002470925672)
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15311mcpsimp"><a name="p15311mcpsimp"></a><a name="p15311mcpsimp"></a>VGA的图像调节结构体，具体参考<a href="#ZH-CN_TOPIC_0000002471085670"><span xml:lang="pt-BR" id="ph15313mcpsimp"><a name="ph15313mcpsimp"></a><a name="ph15313mcpsimp"></a>ot_vo_csc</span></a>。</p>
...
<td class="cellrowborder" valign="top" width="76%" headers="mcps1.1.3.1.2 "><p id="p15396mcpsimp"><a name="p15396mcpsimp"></a><a name="p15396mcpsimp"></a>HDMI的图像调节结构体，具体参考<a href="#ZH-CN_TOPIC_0000002471085670"><span xml:lang="pt-BR" id="ph15398mcpsimp"><a name="ph15398mcpsimp"></a><a name="ph15398mcpsimp"></a>ot_vo_csc</span></a>。</p>
...
<p id="p15494mcpsimp"><a name="p15494mcpsimp"></a><a name="p15494mcpsimp"></a>OT_VO_INTF_RGB_16BIT: bit排布[0:15]，bit15在低位；</p>
...
<td class="cellrowborder" valign="top" width="74%" headers="mcps1.1.3.1.2 "><p id="p15571mcpsimp"><a name="p15571mcpsimp"></a><a name="p15571mcpsimp"></a>MIPI的图像调节结构体，具体参考<a href="#ZH-CN_TOPIC_0000002471085670"><span xml:lang="pt-BR" id="ph15573mcpsimp"><a name="ph15573mcpsimp"></a><a name="ph15573mcpsimp"></a>ot_vo_csc</span></a>。</p>
...
<p id="p15974mcpsimp"><a name="p15974mcpsimp"></a><a name="p15974mcpsimp"></a>SINGLE模式下优先级取值范围：[0, <a href="#ZH-CN_TOPIC_0000002504085567">OT_VO_MAX_CHN_NUM</a>-1]。</p>
...
<p id="p73194431967"><a name="p73194431967"></a><a name="p73194431967"></a>抗闪烁效果需要调用VGS实现，故只在SINGLE模式下有效。</p>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p18435mcpsimp"><a name="p18435mcpsimp"></a><a name="p18435mcpsimp"></a>VTTH1中断回调通知函数指针。</p>
</td>
</tr>
<tr id="row11300102852110"><td class="cellrowborder" valign="top" width="46%" headers="mcps1.1.3.1.1 "><p id="p1730002815212"><a name="p1730002815212"></a><a name="p1730002815212"></a>vo_user_notify</p>
</td>
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p43001328132119"><a name="p43001328132119"></a><a name="p43001328132119"></a>VTTH2中断回调通知函数指针。</p>
</td>
</tr>
</tbody>
</table>
