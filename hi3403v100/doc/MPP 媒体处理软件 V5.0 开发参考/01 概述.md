...
-   **[概述](#ZH-CN_TOPIC_0000002408260014)**  

-   **[系统架构](#ZH-CN_TOPIC_0000002441659437)**  

-   **[媒体处理平台架构](#ZH-CN_TOPIC_0000002441699253)**  

-   **[mmz buffer进程隔离](#ZH-CN_TOPIC_0000002408100110)**  

## 概述<a name="ZH-CN_TOPIC_0000002408260014"></a>

媒体处理软件平台\(Media Process Platform,简称MPP\)，可支持应用软件快速开发。该平台对应用软件屏蔽了芯片相关的复杂的底层处理，并对应用软件直接提供MPI（MPP Program Interface）接口完成相应功能。
...
-   **[背景介绍](#ZH-CN_TOPIC_0000002441699249)**  

-   **[多进程共享方式介绍](#ZH-CN_TOPIC_0000002408260010)**  

-   **[与mmz buffer进程隔离机制有关的API介绍](#ZH-CN_TOPIC_0000002441659433)**  
...
-   记分配了mmz buffer的进程为这个buffer的属主进程，默认只有属主进程具备本buffer的读写权限、映射权限、释放权限，其它进程没有。
