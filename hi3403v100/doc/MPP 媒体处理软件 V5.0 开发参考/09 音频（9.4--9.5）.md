# 音频（9.4--9.5）<a name="ZH-CN_TOPIC_0000002539081527"></a>

-   **[数据类型](#ZH-CN_TOPIC_0000002441698609)**  

-   **[错误码](#ZH-CN_TOPIC_0000002408099690)**  
...
-   [OT\_AIO\_MAX\_CHN\_NUM](#ZH-CN_TOPIC_0000002441658757)：定义音频输入/输出设备的最大通道数。
...
-   [OT\_AIO\_MAX\_CHN\_NUM](#ZH-CN_TOPIC_0000002441698693)：定义音频输入/输出设备的最大个数。
...
#### OT\_AIO\_MAX\_CHN\_NUM<a name="ZH-CN_TOPIC_0000002441658757"></a>
...
#### OT\_AIO\_MAX\_NUM<a name="ZH-CN_TOPIC_0000002441698693"></a>
...
```
#define OT_AO_TALKVQE_MASK_ANR		0x2
```
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p xml:lang="pt-BR" id="p13452mcpsimp"><a name="p13452mcpsimp"></a><a name="p13452mcpsimp"></a><span xml:lang="en-US" id="ph13453mcpsimp"><a name="ph13453mcpsimp"></a><a name="ph13453mcpsimp"></a>音频帧缓存深度。该参数取值范围</span>：[2, frame_num], 并且不能大于30。</p>
...
typedef struct {
    td_bool usr_mode;
    td_s8 cozy_noisy_mode; /* cozy-noisy mode:0 close,1 open, default 1*/
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p18040mcpsimp"><a name="p18040mcpsimp"></a><a name="p18040mcpsimp"></a>动态曲线调整后拐点电平Q4，取值范围[-1440,0]， 从大往小存储，即<span xml:lang="sv-SE" id="ph18041mcpsimp"><a name="ph18041mcpsimp"></a><a name="ph18041mcpsimp"></a>new_level_db</span> [n]&gt;= <span xml:lang="sv-SE" id="ph18042mcpsimp"><a name="ph18042mcpsimp"></a><a name="ph18042mcpsimp"></a>new_level_db</span> [n+1]；默认值[0, -174, -528, -736, -1200]。同时必须满足<span xml:lang="sv-SE" id="ph18043mcpsimp"><a name="ph18043mcpsimp"></a><a name="ph18043mcpsimp"></a>new_level_db</span> [n]&gt;= <span xml:lang="sv-SE" id="ph18044mcpsimp"><a name="ph18044mcpsimp"></a><a name="ph18044mcpsimp"></a>old_level_db</span> [n]。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="67%" headers="mcps1.1.3.1.2 "><p id="p10799mcpsimp"><a name="p10799mcpsimp"></a><a name="p10799mcpsimp"></a>先验信噪比最小值，取值为[0, 32767]，默认值为1036。值越小，噪声抑制能力越强。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="67%" headers="mcps1.1.3.1.2 "><p id="p10834mcpsimp"><a name="p10834mcpsimp"></a><a name="p10834mcpsimp"></a>语音保护参数，取值为[1, 99]，默认值为75。值越大，越保护语音。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="67%" headers="mcps1.1.3.1.2 "><p id="p10839mcpsimp"><a name="p10839mcpsimp"></a><a name="p10839mcpsimp"></a>谐波增强开关，取值为[0, 1]，默认值为0。</p>
...
<td class="cellrowborder" valign="top" width="67%" headers="mcps1.1.3.1.2 "><p id="p10845mcpsimp"><a name="p10845mcpsimp"></a><a name="p10845mcpsimp"></a>倒谱平滑开关，取值为[0, 1]，默认值为1。</p>
...
<td class="cellrowborder" valign="top" width="71%" headers="mcps1.1.3.1.2 "><p id="p1394mcpsimp"><a name="p1394mcpsimp"></a><a name="p1394mcpsimp"></a>所允许的最大增益，取值为[-120, 240]，默认值为80。值越大，增益越大。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="83.28999999999999%" headers="mcps1.1.3.1.2 "><p id="p1490059153312"><a name="p1490059153312"></a><a name="p1490059153312"></a>参考信号和回声之间延时，取值范围为[0, 300]，默认值为0，单位：ms。</p>
</td>
</tr>
...
-   当前仅支持in\_chn\_num等于out\_chn\_num的设置。
    -   当AI设备的声道属性为[OT\_AUDIO\_SOUND\_MODE\_MONO](#AUDIO_SOUND_MODE_MONO)时，in\_chn\_num、out\_chn\_num需设置为1；
    -   当AI设备的声道属性为[OT\_AUDIO\_SOUND\_MODE\_STEREO](#AUDIO_SOUND_MODE_STEREO)时，in\_chn\_num、out\_chn\_num需设置为2。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p17007mcpsimp"><a name="p17007mcpsimp"></a><a name="p17007mcpsimp"></a>MICPGA选择IN_D差分输入</p>
</td>
</tr>
</tbody>
</table>
...
-   **[音频基础属性错误码](#ZH-CN_TOPIC_0000002408259470)**  

-   **[音频输入错误码](#ZH-CN_TOPIC_0000002408099566)**  

-   **[音频输出错误码](#ZH-CN_TOPIC_0000002441658777)**  

-   **[音频编码错误码](#ZH-CN_TOPIC_0000002408099474)**  

-   **[音频解码错误码](#ZH-CN_TOPIC_0000002408259570)**  

-   **[Resampler错误码](#ZH-CN_TOPIC_0000002441658925)**  
