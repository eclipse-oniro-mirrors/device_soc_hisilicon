# OpenHarmony 小型系统集成 Hi3403V100 移植案例
...
1.  原生默认arch = "arm"，社区上暂不支持arm64的CPU架构。
    ...
    修改 build/lite/config/BUILDCONFIG.gn使其支持64位
...
>-   若不想使用芯片的硬件增强特性，则可在ohos/vendor/hisilicon/hispark_aifly_linux/config.json设置参数huks_enable_hisilicon_cipher_in_small取值为false。
