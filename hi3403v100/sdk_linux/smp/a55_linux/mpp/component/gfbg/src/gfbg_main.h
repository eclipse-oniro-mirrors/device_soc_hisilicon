...
#define GFBG_TDE_MEMSET_HEIGHT 4096
...
#ifdef CONFIG_GFBG_G3_4096_SUPPORT
#define GFBG_MAX_LAYER_WIDTH_CLUT_G3 4096
#else
...
typedef struct {
    ...
    wait_queue_head_t refresh_job_done;
    spinlock_t lock;
    td_bool layer_open;
    td_u64 rotate_vb;
    td_u64 displaying_addr;
} gfbg_par;
