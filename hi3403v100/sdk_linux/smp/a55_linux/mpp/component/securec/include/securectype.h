...
#if defined(SECUREC_STDC_WANT_SECURE_LIB) && (!SECUREC_STDC_WANT_SECURE_LIB)
...
#ifdef SECUREC_STDC_WANT_SECURE_LIB
#undef SECUREC_STDC_WANT_SECURE_LIB
#endif
#define SECUREC_STDC_WANT_SECURE_LIB        0
#endif

#if SECUREC_DISABLE_CRT_IMP
#ifdef SECUREC_CRTIMP_ALTERNATIVE
#undef SECUREC_CRTIMP_ALTERNATIVE
#endif
