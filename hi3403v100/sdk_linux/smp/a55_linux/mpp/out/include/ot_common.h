...
#define OT_MK_VERSION_IMPL(x, y, z, p, b) #x "." #y "." #z "." #p " B0" #b
#define MK_VERSION(x, y, z, p, b) OT_MK_VERSION_IMPL(x, y, z, p, b)
...
#define OT_MPP_MOD_SYNC           "sync"
#define OT_MPP_MOD_AIV            "aiv"
