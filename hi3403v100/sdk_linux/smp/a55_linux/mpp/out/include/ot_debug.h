...
#define OT_EX_FILE_LINE_IMPL(fxx, lxx) "[File]:" fxx "\n[Line]:" #lxx "\n[Info]:"
#define EX__FILE_LINE(fxx, lxx) OT_EX_FILE_LINE_IMPL(fxx, lxx)
#define OT_FILE_LINE EX__FILE_LINE(__FILE__, __LINE__)
