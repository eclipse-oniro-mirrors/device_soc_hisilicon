...
typedef struct {
    ...
    td_u32                   sf_ex;               /* RW; Range: [0, 255]; */
    td_u32                   mdz_ex;              /* RW; Range: [0, 63]; */
    td_u32                   eg_prot_ex0;         /* RW; Range: [0, 16]; */
    td_u32                   eg_prot_ex1;         /* RW; Range: [0, 16]; */
    td_u32                   eg_prot;             /* RW; Range: [0, 16]; */
    td_u32                   c_eg_prot;           /* RW; Range: [0, 63]; */
    td_u32                   cmad;                /* RW; Range: [0, 63]; */
...
typedef struct {
    ...
    td_bool                 multi_task_one_grp_en;  /* RW; Range: [0, 1]; multi task one grp enable */
    /* RW: Range: [40, 160]; A node chain organized by weight threshold is delivered to the hardware. */
    td_u32                  chain_weight_threshold;
    td_bool                 output_low_delay_support; /* RW; Range: [0, 1]; Channel output low delay support. */
    td_bool                 cal_cost_time_en;       /* RW; Range: [0, 1]; Whether to take statistics of time. */
} ot_vpss_mod_param;
...
typedef struct {
    td_bool scale_ex_support;       /* RW; Range: [0, 1]; Channel scale extend support. */
    td_bool chn_proc_ex_support;    /* RW; Range: [0, 1]; Channel processing extend support. */
} ot_vpss_chn_cfg;
