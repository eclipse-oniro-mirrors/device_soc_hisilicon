...
#define OT_MIPI_TX_SET_DEV_CFG  OSAL_IOW(OT_MIPI_TX_IOC_MAGIC, 0x01, combo_dev_cfg_t)
#define OT_MIPI_TX_SET_CMD      OSAL_IOW(OT_MIPI_TX_IOC_MAGIC, 0x02, cmd_info_t)
#define OT_MIPI_TX_ENABLE       OSAL_IO(OT_MIPI_TX_IOC_MAGIC, 0x03)
#define OT_MIPI_TX_GET_CMD      OSAL_IOWR(OT_MIPI_TX_IOC_MAGIC, 0x04, get_cmd_info_t)
#define OT_MIPI_TX_DISABLE      OSAL_IO(OT_MIPI_TX_IOC_MAGIC, 0x05)
