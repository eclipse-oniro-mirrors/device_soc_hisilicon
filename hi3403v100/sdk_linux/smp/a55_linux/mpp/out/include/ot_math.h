...
#define OT_MATH_ARRAY_INDEX_2                  2
#define OT_MATH_ARRAY_INDEX_3                  3
#define OT_MATH_SHIFT_112                      112
#define OT_MATH_SHIFT_128                      128
#define OT_MATH_SHIFT_4                        4
#define OT_MATH_SHIFT_66                       66
#define OT_MATH_SHIFT_76                       76
#define OT_MATH_COLOR_SHIFT_BITS               8
#define OT_MATH_Y_LIMIT_OFFSET                 16
#define OT_MATH_Y_LIMIT_COEF_G                 129
#define OT_MATH_Y_LIMIT_COEF_B                 25
#define OT_MATH_CB_LIMIT_COEF_R                38
#define OT_MATH_CB_LIMIT_COEF_G                74
#define OT_MATH_CR_LIMIT_COEF_G                94
#define OT_MATH_CR_LIMIT_COEF_B                18
#define OT_MATH_Y_FULL_COEF_G                  150
#define OT_MATH_Y_FULL_COEF_B                  29
#define OT_MATH_CB_FULL_COEF_R                 43
#define OT_MATH_CB_FULL_COEF_G                 84
#define OT_MATH_CR_FULL_COEF_G                 107
#define OT_MATH_CR_FULL_COEF_B                 20
#define OT_MATH_YUV_10BIT_MAX                  1023
#define OT_MATH_YUV_8BIT_MAX                   255
...
__inline static td_bool is_little_end(void)
{
    ...
    end_test.test[OT_MATH_ARRAY_INDEX_2] = 0x03;
    end_test.test[OT_MATH_ARRAY_INDEX_3] = 0x04;
...
__inline static td_void rgb_to_yc(const rgb_to_yc_param *param)
{
    /* Y */
    *param->y = (td_u16)((((param->r * OT_MATH_SHIFT_66 + param->g * OT_MATH_Y_LIMIT_COEF_G +
        param->b * OT_MATH_Y_LIMIT_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) +
        OT_MATH_Y_LIMIT_OFFSET) << OT_MATH_ARRAY_INDEX_2);

    /* cb */
    *param->cb = (td_u16)(((((param->b * OT_MATH_SHIFT_112 - param->r * OT_MATH_CB_LIMIT_COEF_R) -
        param->g * OT_MATH_CB_LIMIT_COEF_G) >> OT_MATH_COLOR_SHIFT_BITS) +
        OT_MATH_SHIFT_128) << OT_MATH_ARRAY_INDEX_2);

    /* cr */
    *param->cr = (td_u16)(((((param->r * OT_MATH_SHIFT_112 - param->g * OT_MATH_CR_LIMIT_COEF_G) -
        param->b * OT_MATH_CR_LIMIT_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) +
        OT_MATH_SHIFT_128) << OT_MATH_ARRAY_INDEX_2);
}
...
__inline static td_u32 rgb_to_yuv(td_u32 rgb)
{
    ...
    td_u16 u;
    td_u16 v;
    rgb_to_yc_param param = { RGB_R(rgb), RGB_G(rgb), RGB_B(rgb), &y, &u, &v };
...
static td_void rgb_to_yc_full(const rgb_to_yc_param *param)
{
    td_u16 y_tmp;
    td_u16 cb_tmp;
    td_u16 cr_tmp;

    y_tmp = (td_u16)(((param->r * OT_MATH_SHIFT_76 + param->g * OT_MATH_Y_FULL_COEF_G +
        param->b * OT_MATH_Y_FULL_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) * OT_MATH_SHIFT_4);
    cb_tmp = (td_u16)(clip_min(((((param->b * OT_MATH_SHIFT_128 - param->r * OT_MATH_CB_FULL_COEF_R) -
        param->g * OT_MATH_CB_FULL_COEF_G) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_SHIFT_128), 0) *
        OT_MATH_SHIFT_4);
    cr_tmp = (td_u16)(clip_min(((((param->r * OT_MATH_SHIFT_128 - param->g * OT_MATH_CR_FULL_COEF_G) -
        param->b * OT_MATH_CR_FULL_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_SHIFT_128), 0) *
        OT_MATH_SHIFT_4);

    *param->y = MAX2(MIN2(y_tmp, OT_MATH_YUV_10BIT_MAX), 0);
    *param->cb = MAX2(MIN2(cb_tmp, OT_MATH_YUV_10BIT_MAX), 0);
    *param->cr = MAX2(MIN2(cr_tmp, OT_MATH_YUV_10BIT_MAX), 0);
}
...
typedef struct {
    ...
    td_u8 *cb;
    td_u8 *cr;
} rgb_to_yc_8bit_param;

__inline static td_void rgb_to_yc_8bit(const rgb_to_yc_8bit_param *param)
{
    /* Y */
    *param->y = (td_u8)(((param->r * OT_MATH_SHIFT_66 + param->g * OT_MATH_Y_LIMIT_COEF_G +
        param->b * OT_MATH_Y_LIMIT_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_Y_LIMIT_OFFSET);

    /* cb */
    *param->cb = (td_u8)((((param->b * OT_MATH_SHIFT_112 - param->r * OT_MATH_CB_LIMIT_COEF_R) -
        param->g * OT_MATH_CB_LIMIT_COEF_G) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_SHIFT_128);

    /* cr */
    *param->cr = (td_u8)((((param->r * OT_MATH_SHIFT_112 - param->g * OT_MATH_CR_LIMIT_COEF_G) -
        param->b * OT_MATH_CR_LIMIT_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_SHIFT_128);
}
...
__inline static td_u32 rgb_to_yuv_8bit(td_u32 rgb)
{
    ...
    td_u8 u;
    td_u8 v;
    rgb_to_yc_8bit_param param = { RGB_R(rgb), RGB_G(rgb), RGB_B(rgb), &y, &u, &v };

    rgb_to_yc_8bit(&param);

    return YUV_8BIT(y, u, v);
}

/* rgbfull to yuv601full */
static td_void rgb_to_yc_full_8bit(const rgb_to_yc_8bit_param *param)
{
    td_s16 y_tmp;
    td_s16 cb_tmp;
    td_s16 cr_tmp;

    y_tmp = (param->r * OT_MATH_SHIFT_76 + param->g * OT_MATH_Y_FULL_COEF_G +
        param->b * OT_MATH_Y_FULL_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS;
    cb_tmp = (((param->b * OT_MATH_SHIFT_128 - param->r * OT_MATH_CB_FULL_COEF_R) -
        param->g * OT_MATH_CB_FULL_COEF_G) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_SHIFT_128;
    cr_tmp = (((param->r * OT_MATH_SHIFT_128 - param->g * OT_MATH_CR_FULL_COEF_G) -
        param->b * OT_MATH_CR_FULL_COEF_B) >> OT_MATH_COLOR_SHIFT_BITS) + OT_MATH_SHIFT_128;

    *param->y = MAX2(MIN2(y_tmp, OT_MATH_YUV_8BIT_MAX), 0);
    *param->cb = MAX2(MIN2(cb_tmp, OT_MATH_YUV_8BIT_MAX), 0);
    *param->cr = MAX2(MIN2(cr_tmp, OT_MATH_YUV_8BIT_MAX), 0);
}
