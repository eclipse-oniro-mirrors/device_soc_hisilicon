...
typedef struct {
    tde_color_key_mode colorkey_mode; /* color key mode */
    drv_tde_color_key colorkey_value;        /* color key value */
} tde_color_key_cmd;
...
typedef struct {
    ...
    td_u8 coef0_last_line;
    td_u8 coef0_cur_line;
    td_u8 coef0_next_line;
    td_u8 coef1_last_line;
    td_u8 coef1_cur_line;
    td_u8 coef1_next_line;
    td_u8 coef2_last_line;
    td_u8 coef2_cur_line;
    td_u8 coef2_next_line;
    td_u8 coef3_last_line;
    td_u8 coef3_cur_line;
    td_u8 coef3_next_line;
    td_u8 threshold0;
    td_u8 threshold1;
    td_u8 threshold2;
    drv_tde_deflicker_mode deflicker_mode;
} tde_flicker_cmd;
...
typedef struct {
    ...
    td_bool first_line_out;
    td_bool last_line_out;
} tde_resize_cmd;
 ...
 * ,add component order register and member variables:rgb_order.
 */
typedef struct {
    /* Bitmap head addr */
    ...
    /* Vertical scanning direction */
    tde_vscan_mode ver_scan;

    /* Horizontal scanning direction */
    tde_hscan_mode hor_scan;
    td_bool cma;
} tde_surface_msg;
...
typedef struct {
    td_u32 start_in_x; /* Start X,Y imported after MB adjust */
    td_u32 start_in_y;
    td_u32 start_out_x; /* Start X,Y exported after MB adjust */
    td_u32 start_out_y;
...
typedef struct {
    td_bool double_source;
    td_s32 diff_x; /* differences between S1x and Tx */
    td_s32 diff_y; /* differences between S1y and Ty */
...
typedef drv_tde_out_alpha_from tde_drv_outalpha_from;
 ...
 */
td_void tde_hal_node_set_tqt(tde_hw_node *hw_node, tde_surface_msg *drv_surface, tde_drv_outalpha_from enAlphaFrom);

/*
 * Function:      tde_hal_node_set_corner_rect
 * Description:   Set corner information
 * Input:         hw_node: Node struct pointer used in cache by software
...
/*
 * Function:      tde_hal_node_draw_line
 * Description:   Set line information
 * Input:         hw_node: Node struct pointer used in cache by software
 *                line_hal_info: line information used in setting
 *                num: line number
 * Output:        None
 * Return:        None
 * Others:        None
...
td_void tde_hal_node_draw_line(tde_hw_node *hw_node, const tde_line_info *line_hal_info, td_u32 num);
#endif
...
td_s32 tde_hal_get_deflicer_level(drv_tde_deflicker_level *deflicer_level);

td_s32 tde_hal_set_alpha_threshold(td_u8 threshold_value);

td_s32 tde_hal_get_alpha_threshold(td_u8 *threshold_value);
...
td_phys_addr_t tde_hal_cur_node(td_void);
/*
