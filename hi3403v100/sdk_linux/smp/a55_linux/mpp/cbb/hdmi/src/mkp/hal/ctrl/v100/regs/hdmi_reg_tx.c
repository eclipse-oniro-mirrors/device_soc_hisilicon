...
int hdmi_reg_tx_hdmi_regs_init(const td_char *addr)
{
    g_tx_hdmi_regs = (volatile tx_hdmi_reg_regs_type *)(addr + HDMI_TX_BASE_ADDR_HDMITX);
    return TD_SUCCESS;
}

int hdmi_reg_tx_hdmi_regs_deinit(td_void)
{
    if (g_tx_hdmi_regs != TD_NULL) {
        g_tx_hdmi_regs = TD_NULL;
    }
    return TD_SUCCESS;
}

td_void hdmi_reg_tmds_pack_mode_set(td_u8 tmds_pack_mode)
{
    td_u32 *reg_addr = NULL;
    tx_pack_fifo_ctrl tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->pack_fifo_ctrl.u32);
...
td_void hdmi_reg_avi_pkt_header_hb_set(td_u8 hb0, td_u8 hb1, td_u8 hb2)
{
    td_u32 *reg_addr = NULL;
    avi_pkt_header tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_head.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt0_low_set(td_u8 avi_pkt0_pb0, td_u8 avi_pkt0_pb1, td_u8 avi_pkt0_pb2, td_u8 avi_pkt0_pb3)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt0_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt0l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt0_high_set(td_u8 avi_pkt0_pb4, td_u8 avi_pkt0_pb5, td_u8 avi_pkt0_pb6)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt0_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt0h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt1_low_set(td_u8 avi_pkt1_pb0,
    td_u8 avi_pkt1_pb1, td_u8 avi_pkt1_pb2, td_u8 avi_pkt1_pb3)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt1_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt1l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt1_high_set(td_u8 avi_pkt1_pb4, td_u8 avi_pkt1_pb5, td_u8 avi_pkt1_pb6)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt1_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt1h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt2_low_set(td_u8 avi_pkt2_pb0,
    td_u8 avi_pkt2_pb1, td_u8 avi_pkt2_pb2, td_u8 avi_pkt2_pb3)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt2_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt2l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt2_high_set(td_u8 avi_pkt2_pb4, td_u8 avi_pkt2_pb5, td_u8 avi_pkt2_pb6)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt2_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt2h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt3_low_set(td_u8 avi_pkt3_pb0, td_u8 avi_pkt3_pb1, td_u8 avi_pkt3_pb2,
    td_u8 avi_pkt3_pb3)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt3_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt3l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt3_high_set(td_u8 avi_pkt3_pb4, td_u8 avi_pkt3_pb5, td_u8 avi_pkt3_pb6)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt3_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_pkt3h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_avi_pkt_header_hb_get(avi_pkt_header *avi_header)
{
    td_u32 *reg_addr = NULL;
    avi_pkt_header tmp;
...
td_void hdmi_reg_avi_pkt0_low_get(avi_sub_pkt0_low *avi_pkt0_low)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt0_low tmp;
...
td_void hdmi_reg_avi_pkt0_high_get(avi_sub_pkt0_high *avi_pkt0_high)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt0_high tmp;
...
td_void hdmi_reg_avi_pkt1_low_get(avi_sub_pkt1_low *avi_pkt1_low)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt1_low tmp;
...
td_void hdmi_reg_avi_pkt1_high_get(avi_sub_pkt1_high *avi_pkt1_h)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt1_high tmp;
...
td_void hdmi_reg_avi_pkt2_low_get(avi_sub_pkt2_low *avi_pkt2_l)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt2_low tmp;
...
td_void hdmi_reg_avi_pkt2_high_get(avi_sub_pkt2_high *avi_pkt2_h)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt2_high tmp;
...
td_void hdmi_reg_avi_pkt3_low_get(avi_sub_pkt3_low *avi_pkt3_low)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt3_low tmp;
...
td_void hdmi_reg_avi_pkt3_high_get(avi_sub_pkt3_high *avi_pkt3_high)
{
    td_u32 *reg_addr = NULL;
    avi_sub_pkt3_high tmp;
...
td_void hdmi_reg_audio_pkt_header_set(td_u8 hb0, td_u8 hb1, td_u8 hb2)
{
    td_u32 *reg_addr = NULL;
    aif_pkt_header tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt_head.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt0_low_set(td_u8 audio_pkt0_pb0,
    td_u8 audio_pkt0_pb1, td_u8 audio_pkt0_pb2, td_u8 audio_pkt0_pb3)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt0_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt0l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt0_high_set(td_u8 audio_pkt0_pb4,
    td_u8 audio_pkt0_pb5, td_u8 audio_pkt0_pb6)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt0_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt0h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt1_low_set(td_u8 audio_pkt1_pb0,
    td_u8 audio_pkt1_pb1, td_u8 audio_pkt1_pb2, td_u8 audio_pkt1_pb3)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt1_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt1l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt1_high_set(td_u8 audio_pkt1_pb4,
    td_u8 audio_pkt1_pb5, td_u8 audio_pkt1_pb6)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt1_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt1h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt2_low_set(td_u8 audio_pkt2_pb0,
    td_u8 audio_pkt2_pb1, td_u8 audio_pkt2_pb2, td_u8 audio_pkt2_pb3)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt2_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt2l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt2_high_set(td_u8 audio_pkt2_pb4,
    td_u8 audio_pkt2_pb5, td_u8 audio_pkt2_pb6)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt2_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt2h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt3_low_set(td_u8 audio_pkt3_pb0,
    td_u8 audio_pkt3_pb1, td_u8 audio_pkt3_pb2, td_u8 audio_pkt3_pb3)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt3_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt3l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_audio_pkt3_high_set(td_u8 audio_pkt3_pb4,
    td_u8 audio_pkt3_pb5, td_u8 audio_pkt3_pb6)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt3_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aif_pkt3h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_aif_pkt_header_get(aif_pkt_header *aif_header)
{
    td_u32 *reg_addr = NULL;
    aif_pkt_header tmp;
...
td_void hdmi_reg_aif_pkt0_low_get(aif_sub_pkt0_low *aif_pkt0_low)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt0_low tmp;
...
td_void hdmi_reg_aif_pkt0_high_get(aif_sub_pkt0_high *aif_pkt0_high)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt0_high tmp;
...
td_void hdmi_reg_aif_pkt1_low_get(aif_sub_pkt1_low *aif_pkt1_low)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt1_low tmp;
...
td_void hdmi_reg_aif_pkt1_high_get(aif_sub_pkt1_high *aif_pkt1_high)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt1_high tmp;
...
td_void hdmi_reg_aif_pkt2_low_get(aif_sub_pkt2_low *aif_pkt2_low)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt2_low tmp;
...
td_void hdmi_reg_aif_pkt2_high_get(aif_sub_pkt2_high *aif_pkt2_high)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt2_high tmp;
...
td_void hdmi_reg_aif_pkt3_low_get(aif_sub_pkt3_low *aif_pkt3_low)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt3_low tmp;
...
td_void hdmi_reg_aif_pkt3_high_get(aif_sub_pkt3_high *aif_pkt3_high)
{
    td_u32 *reg_addr = NULL;
    aif_sub_pkt3_high tmp;
...
td_void hdmi_reg_gamut_pkt_header_get(gamut_pkt_header *gamut_header)
{
    td_u32 *reg_addr = NULL;
    gamut_pkt_header tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt_head.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt0_low_get(gamut_sub_pkt0_low *gamut_pkt0_low)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt0_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt0l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt0_high_get(gamut_sub_pkt0_high *gamut_pkt0_high)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt0_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt0h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt1_low_get(gamut_sub_pkt1_low *gamut_pkt1_low)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt1_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt1l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt1_high_get(gamut_sub_pkt1_high *gamut_pkt1_high)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt1_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt1h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt2_low_get(gamut_sub_pkt2_low *gamut_pkt2_low)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt2_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt2l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt2_high_get(gamut_sub_pkt2_high *gamut_pkt2_high)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt2_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt2h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt3_low_get(gamut_sub_pkt3_low *gamut_pkt3_low)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt3_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt3l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_gamut_pkt3_high_get(gamut_sub_pkt3_high *gamut_pkt3_high)
{
    td_u32 *reg_addr = NULL;
    gamut_sub_pkt3_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_pkt3h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_header_set(td_u8 hb0, td_u8 hb1, td_u8 hb2)
{
    td_u32 *reg_addr = NULL;
    vsif_pkt_header tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt_head.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt0_low_set(td_u8 vsif_pkt0_pb0,
    td_u8 vsif_pkt0_pb1, td_u8 vsif_pkt0_pb2, td_u8 vsif_pkt0_pb3)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt0_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt0l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt0_high_set(td_u8 vsif_pkt0_pb4, td_u8 vsif_pkt0_pb5, td_u8 vsif_pkt0_pb6)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt0_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt0h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt1_low_set(td_u8 vsif_pkt1_pb0,
    td_u8 vsif_pkt1_pb1, td_u8 vsif_pkt1_pb2, td_u8 vsif_pkt1_pb3)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt1_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt1l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt1_high_set(td_u8 vsif_pkt1_pb4, td_u8 vsif_pkt1_pb5, td_u8 vsif_pkt1_pb6)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt1_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt1h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt2_low_set(td_u8 vsif_pkt2_pb0,
    td_u8 vsif_pkt2_pb1, td_u8 vsif_pkt2_pb2, td_u8 vsif_pkt2_pb3)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt2_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt2l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt2_high_set(td_u8 vsif_pkt2_pb4, td_u8 vsif_pkt2_pb5, td_u8 vsif_pkt2_pb6)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt2_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt2h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt3_low_set(td_u8 vsif_pkt3_pb0,
    td_u8 vsif_pkt3_pb1, td_u8 vsif_pkt3_pb2, td_u8 vsif_pkt3_pb3)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt3_low tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt3l.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_vsif_pkt3_high_set(td_u8 vsif_pkt3_pb4, td_u8 vsif_pkt3_pb5, td_u8 vsif_pkt3_pb6)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt3_high tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_pkt3h.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_cea_avi_rpt_en_set(td_u8 cea_avi_rpt_en)
{
    td_u32 *reg_addr = NULL;
    cea_avi_cfg tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avi_cfg.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_cea_avi_en_set(td_u8 cea_avi_en)
{
    td_u32 *reg_addr = NULL;
    cea_avi_cfg tmp;
...
td_void hdmi_reg_vsif_pkt_header_get(vsif_pkt_header *vsif_header)
{
    td_u32 *reg_addr = NULL;
    vsif_pkt_header tmp;
...
td_void hdmi_reg_vsif_pkt0_low_get(vsif_sub_pkt0_low *vsif_pkt0_low)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt0_low tmp;
...
td_void hdmi_reg_vsif_pkt0_high_get(vsif_sub_pkt0_high *vsif_pkt0_high)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt0_high tmp;
...
td_void hdmi_reg_vsif_pkt1_low_get(vsif_sub_pkt1_low *vsif_pkt1_low)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt1_low tmp;
...
td_void hdmi_reg_vsif_pkt1_high_get(vsif_sub_pkt1_high *vsif_pkt1_high)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt1_high tmp;
...
td_void hdmi_reg_vsif_pkt2_low_get(vsif_sub_pkt2_low *vsif_pkt2_low)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt2_low tmp;
...
td_void hdmi_reg_vsif_pkt2_high_get(vsif_sub_pkt2_high *vsif_pkt2_high)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt2_high tmp;
...
td_void hdmi_reg_vsif_pkt3_low_get(vsif_sub_pkt3_low *vsif_pkt3_low)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt3_low tmp;
...
td_void hdmi_reg_vsif_pkt3_high_get(vsif_sub_pkt3_high *vsif_pkt3_high)
{
    td_u32 *reg_addr = NULL;
    vsif_sub_pkt3_high tmp;
...
td_void hdmi_reg_cea_aud_rpt_en_set(td_u8 cea_aud_rpt_en)
{
    td_u32 *reg_addr = NULL;
    cea_aud_cfg tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->aud_cfg.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_cea_aud_en_set(td_u8 cea_aud_en)
{
    td_u32 *reg_addr = NULL;
    cea_aud_cfg tmp;
...
td_void hdmi_reg_cea_cp_rpt_cnt_set(td_u8 cea_cp_rpt_cnt)
{
    td_u32 *reg_addr = NULL;
    cea_cp_cfg tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->cp_cfg.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_cea_cp_rpt_en_set(td_u8 cea_cp_rpt_en)
{
    td_u32 *reg_addr = NULL;
    cea_cp_cfg tmp;
...
td_void hdmi_reg_cea_cp_en_set(td_u8 cea_cp_en)
{
    td_u32 *reg_addr = NULL;
    cea_cp_cfg tmp;
...
td_void hdmi_reg_cea_vsif_rpt_en_set(td_u8 cea_vsif_rpt_en)
{
    td_u32 *reg_addr = NULL;
    cea_vsif_cfg tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->vsif_cfg.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_cea_vsif_en_set(td_u8 cea_vsif_en)
{
    td_u32 *reg_addr = NULL;
    cea_vsif_cfg tmp;
...
td_void hdmi_reg_dc_pkt_en_set(td_u8 dc_pkt_en)
{
    td_u32 *reg_addr = NULL;
    cea_avmixer_config tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->avmixer_cfg.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_hdmi_mode_set(td_u8 hdmi_mode)
{
    td_u32 *reg_addr = NULL;
    cea_avmixer_config tmp;
...
td_void hdmi_reg_cp_clr_avmute_set(td_u8 cp_clr_avmute)
{
    td_u32 *reg_addr = NULL;
    cp_pkt_avmute tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->pkt_avmute.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_cp_set_avmute_set(td_u8 cp_set_avmute)
{
    td_u32 *reg_addr = NULL;
    cp_pkt_avmute tmp;
...
td_void hdmi_reg_enc_bypass_set(td_u8 enc_bypass)
{
    td_u32 *reg_addr = NULL;
    hdmi_enc_ctrl tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->enc_ctrl.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
...
td_void hdmi_reg_enc_scr_on_set(td_u8 enc_scr_on)
{
    td_u32 *reg_addr = NULL;
    hdmi_enc_ctrl tmp;
...
td_void hdmi_reg_enc_hdmi2_on_set(td_u8 enc_hdmi2_on)
{
    td_u32 *reg_addr = NULL;
    hdmi_enc_ctrl tmp;
...
td_u8 hdmi_reg_tmds_pack_mode_get(td_void)
{
    td_u32 *reg_addr = NULL;
    tx_pack_fifo_ctrl tmp;
...
td_u8 hdmi_reg_pclk2tclk_stable_get(td_void)
{
    td_u32 *reg_addr = NULL;
    tx_pack_fifo_st tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->pack_fifo_status.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
    return tmp.bits.pclk2tclk_stable;
}

td_u8 hdmi_reg_cea_avi_en_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_avi_cfg tmp;
...
td_u8 hdmi_reg_cea_aud_en_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_aud_cfg tmp;
...
td_u8 hdmi_reg_cea_cp_rpt_en_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_cp_cfg tmp;
...
td_u8 hdmi_reg_cea_gamut_en_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_gamut_cfg tmp;

    reg_addr = (td_u32 *)&(g_tx_hdmi_regs->gamut_cfg.u32);
    tmp.u32 = hdmi_tx_reg_read(reg_addr);
    return tmp.bits.cea_gamut_en;
}

td_u8 hdmi_reg_cea_vsif_rpt_en_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_vsif_cfg tmp;
...
td_u8 hdmi_reg_dc_pkt_en_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_avmixer_config tmp;
...
td_u8 hdmi_reg_hdmi_mode_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cea_avmixer_config tmp;
...
td_u8 hdmi_reg_cp_set_avmute_get(td_void)
{
    td_u32 *reg_addr = NULL;
    cp_pkt_avmute tmp;
...
td_u8 hdmi_reg_enc_scr_on_get(td_void)
{
    td_u32 *reg_addr = NULL;
    hdmi_enc_ctrl tmp;
...
td_u8 hdmi_reg_enc_hdmi2_on_get(td_void)
{
    td_u32 *reg_addr = NULL;
    hdmi_enc_ctrl tmp;
