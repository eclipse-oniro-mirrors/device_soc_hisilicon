 ...
 */
#ifndef HHDMI_REG_TX_H
#define HHDMI_REG_TX_H
...
td_void hdmi_reg_avi_pkt1_low_set(td_u8 avi_pkt1_pb0, td_u8 avi_pkt1_pb1, td_u8 avi_pkt1_pb2, td_u8 avi_pkt1_pb3);
td_void hdmi_reg_avi_pkt1_high_set(td_u8 avi_pkt1_pb4, td_u8 avi_pkt1_pb5, td_u8 avi_pkt1_pb6);
td_void hdmi_reg_avi_pkt2_low_set(td_u8 avi_pkt2_pb0, td_u8 avi_pkt2_pb1, td_u8 avi_pkt2_pb2, td_u8 avi_pkt2_pb3);
td_void hdmi_reg_avi_pkt2_high_set(td_u8 avi_pkt2_pb4, td_u8 avi_pkt2_pb5, td_u8 avi_pkt2_pb6);
td_void hdmi_reg_avi_pkt3_low_set(td_u8 avi_pkt3_pb0, td_u8 avi_pkt3_pb1, td_u8 avi_pkt3_pb2, td_u8 avi_pkt3_pb3);
td_void hdmi_reg_avi_pkt3_high_set(td_u8 avi_pkt3_pb4, td_u8 avi_pkt3_pb5, td_u8 avi_pkt3_pb6);
td_void hdmi_reg_avi_pkt_header_hb_get(avi_pkt_header *pkt_header);
td_void hdmi_reg_avi_pkt0_low_get(avi_sub_pkt0_low *sub_pkt0_low);
td_void hdmi_reg_avi_pkt0_high_get(avi_sub_pkt0_high *sub_pkt0_high);
td_void hdmi_reg_avi_pkt1_low_get(avi_sub_pkt1_low *sub_pkt1_low);
td_void hdmi_reg_avi_pkt1_high_get(avi_sub_pkt1_high *sub_pkt1_high);
td_void hdmi_reg_avi_pkt2_low_get(avi_sub_pkt2_low *sub_pkt2_low);
td_void hdmi_reg_avi_pkt2_high_get(avi_sub_pkt2_high *sub_pkt2_high);
td_void hdmi_reg_avi_pkt3_low_get(avi_sub_pkt3_low *sub_pkt3_low);
td_void hdmi_reg_avi_pkt3_high_get(avi_sub_pkt3_high *sub_pkt3_high);
td_void hdmi_reg_audio_pkt_header_set(td_u8 hb0, td_u8 hb1, td_u8 hb2);
td_void hdmi_reg_audio_pkt0_low_set(td_u8 avi_pkt0_pb0, td_u8 avi_pkt0_pb1, td_u8 avi_pkt0_pb2, td_u8 avi_pkt0_pb3);
td_void hdmi_reg_audio_pkt0_high_set(td_u8 avi_pkt0_pb4, td_u8 avi_pkt0_pb5, td_u8 avi_pkt0_pb6);
td_void hdmi_reg_audio_pkt1_low_set(td_u8 avi_pkt1_pb0, td_u8 avi_pkt1_pb1, td_u8 avi_pkt1_pb2, td_u8 avi_pkt1_pb3);
td_void hdmi_reg_audio_pkt1_high_set(td_u8 avi_pkt1_pb4, td_u8 avi_pkt1_pb5, td_u8 avi_pkt1_pb6);
td_void hdmi_reg_audio_pkt2_low_set(td_u8 avi_pkt2_pb0, td_u8 avi_pkt2_pb1, td_u8 avi_pkt2_pb2, td_u8 avi_pkt2_pb3);
td_void hdmi_reg_audio_pkt2_high_set(td_u8 avi_pkt2_pb4, td_u8 avi_pkt2_pb5, td_u8 avi_pkt2_pb6);
td_void hdmi_reg_audio_pkt3_low_set(td_u8 avi_pkt3_pb0, td_u8 avi_pkt3_pb1, td_u8 avi_pkt3_pb2, td_u8 avi_pkt3_pb3);
td_void hdmi_reg_audio_pkt3_high_set(td_u8 avi_pkt3_pb4, td_u8 avi_pkt3_pb5, td_u8 avi_pkt3_pb6);
td_void hdmi_reg_aif_pkt_header_get(aif_pkt_header *pkt_header);
td_void hdmi_reg_aif_pkt0_low_get(aif_sub_pkt0_low *sub_pkt0_low);
td_void hdmi_reg_aif_pkt0_high_get(aif_sub_pkt0_high *sub_pkt0_high);
td_void hdmi_reg_aif_pkt1_low_get(aif_sub_pkt1_low *sub_pkt1_low);
td_void hdmi_reg_aif_pkt1_high_get(aif_sub_pkt1_high *sub_pkt1_high);
td_void hdmi_reg_aif_pkt2_low_get(aif_sub_pkt2_low *sub_pkt2_low);
td_void hdmi_reg_aif_pkt2_high_get(aif_sub_pkt2_high *sub_pkt2_high);
td_void hdmi_reg_aif_pkt3_low_get(aif_sub_pkt3_low *sub_pkt3_low);
td_void hdmi_reg_aif_pkt3_high_get(aif_sub_pkt3_high *sub_pkt3_high);
td_void hdmi_reg_gamut_pkt_header_get(gamut_pkt_header *pkt_header);
td_void hdmi_reg_gamut_pkt0_low_get(gamut_sub_pkt0_low *sub_pkt0_low);
td_void hdmi_reg_gamut_pkt0_high_get(gamut_sub_pkt0_high *sub_pkt0_high);
td_void hdmi_reg_gamut_pkt1_low_get(gamut_sub_pkt1_low *sub_pkt1_low);
td_void hdmi_reg_gamut_pkt1_high_get(gamut_sub_pkt1_high *sub_pkt1_high);
td_void hdmi_reg_gamut_pkt2_low_get(gamut_sub_pkt2_low *sub_pkt2_low);
td_void hdmi_reg_gamut_pkt2_high_get(gamut_sub_pkt2_high *sub_pkt2_high);
td_void hdmi_reg_gamut_pkt3_low_get(gamut_sub_pkt3_low *sub_pkt3_low);
td_void hdmi_reg_gamut_pkt3_high_get(gamut_sub_pkt3_high *sub_pkt3_high);
td_void hdmi_reg_vsif_header_set(td_u8 hb0, td_u8 hb1, td_u8 hb2);
td_void hdmi_reg_vsif_pkt0_low_set(td_u8 vsif_pkt0_pb0, td_u8 vsif_pkt0_pb1, td_u8 vsif_pkt0_pb2, td_u8 vsif_pkt0_pb3);
td_void hdmi_reg_vsif_pkt0_high_set(td_u8 vsif_pkt0_pb4, td_u8 vsif_pkt0_pb5, td_u8 vsif_pkt0_pb6);
td_void hdmi_reg_vsif_pkt1_low_set(td_u8 vsif_pkt1_pb0, td_u8 vsif_pkt1_pb1, td_u8 vsif_pkt1_pb2, td_u8 vsif_pkt1_pb3);
td_void hdmi_reg_vsif_pkt1_high_set(td_u8 vsif_pkt1_pb4, td_u8 vsif_pkt1_pb5, td_u8 vsif_pkt1_pb6);
td_void hdmi_reg_vsif_pkt2_low_set(td_u8 vsif_pkt2_pb0, td_u8 vsif_pkt2_pb1, td_u8 vsif_pkt2_pb2, td_u8 vsif_pkt2_pb3);
td_void hdmi_reg_vsif_pkt2_high_set(td_u8 vsif_pkt2_pb4, td_u8 vsif_pkt2_pb5, td_u8 vsif_pkt2_pb6);
td_void hdmi_reg_vsif_pkt3_low_set(td_u8 vsif_pkt3_pb0, td_u8 vsif_pkt3_pb1, td_u8 vsif_pkt3_pb2, td_u8 vsif_pkt3_pb3);
td_void hdmi_reg_vsif_pkt3_high_set(td_u8 vsif_pkt3_pb4, td_u8 vsif_pkt3_pb5, td_u8 vsif_pkt3_pb6);
td_void hdmi_reg_vsif_pkt_header_get(vsif_pkt_header *pkt_header);
td_void hdmi_reg_vsif_pkt0_low_get(vsif_sub_pkt0_low *sub_pkt0_low);
td_void hdmi_reg_vsif_pkt0_high_get(vsif_sub_pkt0_high *sub_pkt0_high);
td_void hdmi_reg_vsif_pkt1_low_get(vsif_sub_pkt1_low *sub_pkt1_low);
td_void hdmi_reg_vsif_pkt1_high_get(vsif_sub_pkt1_high *sub_pkt1_high);
td_void hdmi_reg_vsif_pkt2_low_get(vsif_sub_pkt2_low *sub_pkt2_low);
td_void hdmi_reg_vsif_pkt2_high_get(vsif_sub_pkt2_high *sub_pkt2_high);
td_void hdmi_reg_vsif_pkt3_low_get(vsif_sub_pkt3_low *sub_pkt3_low);
td_void hdmi_reg_vsif_pkt3_high_get(vsif_sub_pkt3_high *sub_pkt3_high);
