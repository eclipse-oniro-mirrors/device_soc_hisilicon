...
static td_void ctrl_video_path_color_space_get(hdmi_colorspace *in_color_space, hdmi_colorspace *out_color_space)
{
    ...
    td_bool is_yuv422;
    td_bool is_yuv420;
    td_bool is_dwsm_hori_en;
    td_bool is_dwsm_vert_en;
...
static td_void ctrl_vsif_regs_get(ctrl_vsif_regs *regs)
{
    hdmi_reg_vsif_pkt_header_get(&regs->vsif_pkt_head);
    hdmi_reg_vsif_pkt0_low_get(&regs->vsif_sub_pkt0_l);
    hdmi_reg_vsif_pkt0_high_get(&regs->vsif_sub_pkt0_h);
    hdmi_reg_vsif_pkt1_low_get(&regs->vsif_sub_pkt1_l);
    hdmi_reg_vsif_pkt1_high_get(&regs->vsif_sub_pkt1_h);
    hdmi_reg_vsif_pkt2_low_get(&regs->vsif_sub_pkt2_l);
    hdmi_reg_vsif_pkt2_high_get(&regs->vsif_sub_pkt2_h);
    hdmi_reg_vsif_pkt3_low_get(&regs->vsif_sub_pkt3_l);
    hdmi_reg_vsif_pkt3_high_get(&regs->vsif_sub_pkt3_h);
}
...
static td_void avi_infoframe_head_get(td_u8 *data)
{
...
static td_void avi_infoframe_sub_pkt_get(td_u8 *data)
{
...
{
    avi_infoframe_head_get(data);
    avi_infoframe_sub_pkt_get(data);
...
static td_void ctrl_aif_regs_get(ctrl_aif_regs *regs)
{
    hdmi_reg_aif_pkt_header_get(&regs->aif_pkt_head);
    hdmi_reg_aif_pkt0_low_get(&regs->aif_sub_pkt0_l);
    hdmi_reg_aif_pkt0_high_get(&regs->aif_sub_pkt0_h);
    hdmi_reg_aif_pkt1_low_get(&regs->aif_sub_pkt1_l);
    hdmi_reg_aif_pkt1_high_get(&regs->aif_sub_pkt1_h);
    hdmi_reg_aif_pkt2_low_get(&regs->aif_sub_pkt2_l);
    hdmi_reg_aif_pkt2_high_get(&regs->aif_sub_pkt2_h);
    hdmi_reg_aif_pkt3_low_get(&regs->aif_sub_pkt3_l);
    hdmi_reg_aif_pkt3_high_get(&regs->aif_sub_pkt3_h);
}
...
static td_void ctrl_gamut_regs_get(ctrl_gamut_regs *regs)
{
    hdmi_reg_gamut_pkt_header_get(&regs->gamut_pkt_head);
    hdmi_reg_gamut_pkt0_low_get(&regs->gamut_sub_pkt0_l);
    hdmi_reg_gamut_pkt0_high_get(&regs->gamut_sub_pkt0_h);
    hdmi_reg_gamut_pkt1_low_get(&regs->gamut_sub_pkt1_l);
    hdmi_reg_gamut_pkt1_high_get(&regs->gamut_sub_pkt1_h);
    hdmi_reg_gamut_pkt2_low_get(&regs->gamut_sub_pkt2_l);
    hdmi_reg_gamut_pkt2_high_get(&regs->gamut_sub_pkt2_h);
    hdmi_reg_gamut_pkt3_low_get(&regs->gamut_sub_pkt3_l);
    hdmi_reg_gamut_pkt3_high_get(&regs->gamut_sub_pkt3_h);
}
...
td_s32 hal_hdmi_ctrl_video_path_set(hdmi_device_id hdmi, hdmi_video_path *video_path)
{
    ...
    err_code = memcpy_s(&ctrl_info->video_path, sizeof(ctrl_info->video_path), video_path, sizeof(hdmi_video_path));
    if (err_code != EOK) {
