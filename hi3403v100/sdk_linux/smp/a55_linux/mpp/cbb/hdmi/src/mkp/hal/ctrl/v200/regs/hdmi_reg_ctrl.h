 ...
 */
#ifndef HDMI_REG_CTRL_H
#define HDMI_REG_CTRL_H
...
int hdmi_reg_tx_ctrl_regs_init(td_u32 id, const char *addr);
...
td_void hdmi_reg_pwd_mst_cmd_set(td_u32 id, td_u8 pwd_mst_cmd);
