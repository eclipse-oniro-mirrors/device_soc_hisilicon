 ...
 */
#ifndef HDMI_REG_AON_H
#define HDMI_REG_AON_H
...
typedef struct {
    ...
    volatile tx_hw_version       tx_hw_vers;    /* 4004 */
    volatile tx_hw_feature       hw_feature;    /* 4008 */
    unsigned int                 reserved_0[4]; /* 400C-4018 */
    volatile tx_aon_rst_ctrl     aon_rst;       /* 401C */
    volatile hotplug_st_cfg      hpd_cfg;       /* 4020 */
    volatile hotplug_fillter_cfg hpd_filt_cfg;  /* 4024 */
    volatile tx_aon_state        aon_state;     /* 4028 */
    unsigned int                 reserved_2[1]; /* 402C */
    volatile tx_aon_intr_mask    aon_irq_mask;  /* 4030 */
    volatile tx_aon_intr_state   aon_irq_state; /* 4034 */
    unsigned int                 reserved_3[2]; /* 4038-403C */
    volatile ddc_mst_ctrl        ddc_ctrl;      /* 4040 */
    volatile ddc_fifo_rdata      ddc_rdata;     /* 4044 */
    volatile ddc_fifo_wdata      ddc_wdata;     /* 4048 */
    volatile ddc_data_cnt        data_count;    /* 404C */
    volatile ddc_slave_cfg       slave_cfg;     /* 4050 */
    volatile ddc_mst_state       mst_state;     /* 4054 */
    volatile ddc_mst_cmd         mst_cmd;       /* 4058 */
    volatile ddc_man_ctrl        ddc_sw_ctrl;   /* 405C */
    volatile ddc_state_clr       state_clr;     /* 4060 */
} tx_aon_regs;

int hdmi_reg_aon_regs_init(const char *addr);
int hdmi_reg_aon_regs_deinit(void);
td_void hdmi_reg_aon_intr_mask0_set(td_u8 aon_intr_mask0);
td_void hdmi_reg_aon_intr_stat0_set(td_u8 aon_intr_stat0);
td_void hdmi_reg_aon_intr_stat1_set(td_u8 aon_intr_stat1);
td_void hdmi_reg_dcc_man_en_set(td_u8 dcc_man_en);
td_void hdmi_reg_ddc_scl_oen_set(td_u8 ddc_scl_oen);
td_void hdmi_reg_ddc_sda_oen_set(td_u8 ddc_sda_oen);
td_u8 hdmi_reg_ddc_i2c_bus_low_get(void);
td_u8 hdmi_reg_ddc_i2c_no_ack_get(void);
td_u8 hdmi_reg_hpd_polarity_ctl_get(void);
td_u8 hdmi_reg_hotplug_state_get(void);
td_u8 hdmi_reg_phy_rx_sense_get(void);
td_u8 hdmi_reg_aon_intr_stat0_get(void);
td_u8 hdmi_reg_aon_intr_stat1_get(void);
td_u8 hdmi_reg_ddc_scl_st_get(void);
td_u8 hdmi_reg_ddc_sda_st_get(void);
#endif  /* HDMI_REG_AON_H */
