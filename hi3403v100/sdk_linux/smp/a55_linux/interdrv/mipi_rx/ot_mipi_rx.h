...
#define OT_MIPI_SET_DEV_ATTR                OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x01, combo_dev_attr_t)

/* set phy common mode voltage mode */
#define OT_MIPI_SET_PHY_CMVMODE             OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x04, phy_cmv_t)

/* reset sensor */
#define OT_MIPI_RESET_SENSOR                OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x05, sns_rst_source_t)

/* unreset sensor */
#define OT_MIPI_UNRESET_SENSOR              OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x06, sns_rst_source_t)

/* reset mipi */
#define OT_MIPI_RESET_MIPI                  OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x07, combo_dev_t)

/* unreset mipi */
#define OT_MIPI_UNRESET_MIPI                OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x08, combo_dev_t)

/* set mipi hs_mode */
#define OT_MIPI_SET_HS_MODE                 OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x0b, lane_divide_mode_t)

/* enable mipi clock */
#define OT_MIPI_ENABLE_MIPI_CLOCK           OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x0c, combo_dev_t)

/* disable mipi clock */
#define OT_MIPI_DISABLE_MIPI_CLOCK          OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x0d, combo_dev_t)

/* enable sensor clock */
#define OT_MIPI_ENABLE_SENSOR_CLOCK         OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x10, sns_clk_source_t)

/* disable sensor clock */
#define OT_MIPI_DISABLE_SENSOR_CLOCK        OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x11, sns_clk_source_t)

#define OT_MIPI_SET_EXT_DATA_TYPE           OSAL_IOW(OT_MIPI_IOC_MAGIC, 0x12, ext_data_type_t)
