...
SDK_LIB := $(SDK_LIB_PATH) --start-group -lot_osal -l$(KO_PREFIX)_base -l$(KO_PREFIX)_wdt --end-group
...
all: $(BIN)
	@echo -e "\e[0;32;1m--Compiling 'sample_wtdg'...\e[0;36;1m"
	@@echo -e "\e[0m"
