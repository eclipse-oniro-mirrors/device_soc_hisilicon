...
#ifndef OHOS_HDI_IAUDIO_CALLBACK_H
#define OHOS_HDI_IAUDIO_CALLBACK_H
            ...
            namespace Audio {
                namespace V1_0 {
                    class IAudioCallback {
                        ...
                        virtual int32_t RenderCallback(AudioCallbackType type, int8_t &reserved, int8_t &cookie) = 0;
                        virtual int32_t ParamCallback(AudioExtParamKey key, const std::string &condition,
                            const std::string &value, int8_t &reserved, int8_t &cookie) = 0;
                    };
                }
            }
        }
