...
#define OT_ERR_APP_APPID     (0x80000000L + 0x21000000L)
#define OT_ERR_EXT_APP_APPID (0x80000000L + 0x22000000L)

#define OT_APP_DEF_ERR(module, level, errid) \
    ((TD_S32)((OT_ERR_APP_APPID) | ((module) << 16) | ((level) << 13) | (TD_S32)(errid)))

#define OT_EXT_APP_DEF_ERR(module, level, errid) \
    ((TD_S32)((OT_ERR_EXT_APP_APPID) | ((module) << 16) | ((level) << 13) | (TD_S32)(errid)))
