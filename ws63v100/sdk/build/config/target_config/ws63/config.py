...
target = {
    'ws63-liteos-app': {
        ...
        'ram_component': [
            ...
            "hal_sysparam" ,"hievent_lite_static" ,"huks_3.0_sdk"  , "samgr",
            "hidumper_mini","hiview_lite_static","blackbox_lite",
    ...
    'ws63-liteos-xts': {
        ...
        'ram_component': [
            ...
            'printf_adapt',
            'little_fs', 'littlefs_adapt_ws63',
            "begetutil", "devattest_sdk", "hal_token_static" ,    "hilog_lite_static" ,  "huks_test_common",  "module_ActsBootstrapTest"    ,    "module_ActsSamgrTest"  ,      "samgr_adapter",
            ...
            "devattest_core", "hal_sysparam", "hievent_lite_static", "huks_3.0_sdk", "module_ActsHuksHalFunctionTest", "samgr", "module_ActsParameterTest", "module_ActsUtilsFileTest", "module_ActsLwipTest", "module_ActsKvStoreTest", "kv_store",
            "module_ActsWifiIotTest", "hal_iothardware",
            "blackbox_lite",
            "hidumper_mini",
            'xo_trim_port',
        ],
